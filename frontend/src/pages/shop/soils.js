...
// const soils = [
//     { id: 1, imageUrl: '/assets/products/plant-1.jpeg', name: 'Green & Purple Cactus', price: 40 ,category: 'loamy'},
//     { id: 2, imageUrl: '/assets/products/plant-2.jpeg', name: 'Snake Plant', price: 76 ,category: 'loamy'},
//     { id: 3, imageUrl: '/assets/products/plant-3.jpeg', name: 'Green & Red Cactus', price: 58 ,category: 'sandy'},
//     { id: 4, imageUrl: '/assets/products/plant-4.jpeg', name: 'Monstera', price: 32 ,category: 'sandy'},
//     { id: 5, imageUrl: '/assets/products/plant-5.jpeg', name: 'Golden Barrel Cactus', price: 50,category: 'peaty' },
//     { id: 6, imageUrl: '/assets/products/plant-1.jpeg', name: 'Green & Purple Cactus', price: 40 ,category: 'silty'},
//     { id: 7, imageUrl: '/assets/products/plant-2.jpeg', name: 'Snake Plant', price: 76 ,category: 'chalky'},
//     { id: 8, imageUrl: '/assets/products/plant-3.jpeg', name: 'Green & Red Cactus', price: 58 ,category: 'clay'},
// ];

// const categories = ['All', 'loamy', 'sandy', 'peaty', 'silty','chalky','clay'];

// function Soil() {
//     const [selectedCategory, setSelectedCategory] = useState('All');

//     const filteredSoils = selectedCategory === 'All'
//         ? soils
//         : soils.filter((soil) => soil.category === selectedCategory);
...
//                             <div key={soil.id} className="bg-white rounded-lg shadow text-center">
//                                 <img src={soil.imageUrl} alt={soil.name} className="w-full h-full object-cover mb-4 rounded-md" />
//                                 <h3 className="text-lg font-semibold">{soil.name}</h3>
//                                 <p className="text-gray-600">${soil.price.toFixed(2)}</p>
//                             </div>
//                         ))}
//                     </div>
//                 </div>
    ...
    return (
        <div className="max-w-screen mx-auto mb-20">
            ...
            <div 
                ...
                style={{ backgroundImage: `url(/assets/soil.jpg)` }}
            >
                <h2 className="text-3xl md:text-5xl font-bold font-josefin-sans text-white px-4 py-2 rounded">SOILS</h2>
            </div>
            ...
            {/* Main Content */}
                ...
                <div className="w-full mr-10 mb-20 mt-10 lg:w-3/4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-44 gap-x-10">
                        {filteredSoils.map((soil) => (
                            <Link to={`/products/${soil.id}`} key={soil.id} className="bg-white rounded-lg shadow text-center">
                                <img src={soil.imageUrl} alt={soil.name} className="w-full h-full object-cover mb-4 rounded-md" />
                                <h3 className="text-lg font-semibold">{soil.name}</h3>
                                <p className="text-gray-600">${soil.price.toFixed(2)}</p>
                            </Link>
