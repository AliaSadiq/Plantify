...
const LoginPage = () => {
    ...
    return(
        <div className="h-screen md:flex">
            <div
                className="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-navygreen-300 to-ivory i justify-around items-center hidden">
                <div>
            ...
            <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
                <form onSubmit={handleSubmit} className="bg-white">
                    ...
                    <div className="flex items-center border-2 py-2 px-3 rounded-2xl">
                        ...
                        <input className="pl-2 outline-none border-none" type="text" name="password" id="password" placeholder="Password" value={user.password} onChange={handleInput}/>
                    </div>
