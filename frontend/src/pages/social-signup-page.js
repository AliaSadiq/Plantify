...
const SocialSignUpPage = () => {
    ...
    const handleStep2Submit = (e) => {
        e.preventDefault();
        // Validate form data if needed
        // Submit both sets of form data to the backend
    ...
    const renderStep1Form = () => {
        return (
            <form onSubmit={handleStep1Submit}>
                ...
                <label for="logo" class="block font-mini font-josefin-sans mb-1">Logo</label>
    ...
    const renderStep2Form = () => {
        return (
            <form onSubmit={handleStep2Submit}>
                ...
                <div class="mt-4">
                    <button type="submit" class="font-josefin-sans bg-gray-100 text-white text-sm font-semibold px-4 py-2 rounded hover:rounded-full border-2 border-gray-100">Submit</button>
                </div>
            </form>
        );
    };
        ...
        <div className="flex items-center gap-[100px] justify-center pt-40 pb-20">
            {step === 1 ? (
                <>
                    ...
                    <img src={group} alt='leaves illustration' className="w-[600px] mt-8"/>
                </>
            ) : (
                <>
                    <img src={verify} alt='leaves illustration' className="w-[450px]"/>
