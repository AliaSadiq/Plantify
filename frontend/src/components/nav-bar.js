        ...
        <nav className={`fixed w-full z-20 top-0 start-0 ${isScrolled ? 'bg-palegreen-200' : 'bg-transparent'} transition-colors duration-1000 ease-in-out`}>
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <button type="button" onClick={openModal} class="font-josefin-sans bg-navygreen-300 text-sm font-semibold text-gray-100 p-4 rounded-full">Start Donating</button>
