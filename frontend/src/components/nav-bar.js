...
const NavBar = () => {
    return(
        <nav class="bg-palegoldenrod-200 fixed w-full z-20 top-0 start-0">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <button type="button" class="font-josefin-sans bg-yellowgreen-100 text-sm font-semibold text-light-black p-2 rounded-full">Start Donating</button>
