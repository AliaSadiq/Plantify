...
//       try {
//         const response = await axios.get('https://plantify-backend.vercel.app/api/campaigns/data/${socialId}'); // Adjust the endpoint as per your backend route
...
//     const fetchCampaignData = async () => {
//       try {
//         const response = await axios.get(`https://plantify-backend.vercel.app/api/campaigns/data/${socialId}`); // Use template literals here
//         const { campaignCountByYear } = response.data;
...
//     const fetchCampaignData = async () => {
//       try {
//         const response = await axios.get(`https://plantify-backend.vercel.app/api/campaigns/data/${socialId}`);
//         const { campaignCountByYear } = response.data;
...
//     const fetchCampaignData = async () => {
//       try {
//         const response = await axios.get(`https://plantify-backend.vercel.app/api/campaigns/${id}`);
//         const { campaignCountByYear } = response.data;
...
//     const fetchCampaignData = async () => {
//       try {
//         const response = await axios.get(`https://plantify-backend.vercel.app/api/campaigns/${socialGroupId}`);
//         const { campaignCountByYear } = response.data;
  ...
  useEffect(() => {
    ...
    const fetchCampaignData = async () => {
      try {
        ...
        const response = await axios.get(`https://plantify-backend.vercel.app/api/campaigns/socialg/${id}`);
