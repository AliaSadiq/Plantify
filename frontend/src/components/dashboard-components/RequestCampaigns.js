...
//       try {
//         const response = await axios.get("https://plantify-backend.vercel.app/api/campaigns"); // Replace with your API URL
...
//         await axios.delete(`https://plantify-backend.vercel.app/api/campaigns/${selectedCampaign._id}`);
...
//         // await axios.put(`https://plantify-backend.vercel.app/api/campaigns/${selectedCampaign._id}`, { status: 'Accepted' });
